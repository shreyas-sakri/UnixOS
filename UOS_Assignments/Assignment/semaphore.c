//UOS LA4
//Problem Statement- Write a program to illustrate the semaphore concept. Use fork so that 2 process running simultaneously and communicate via semaphore. 
//Name- Sarita Gajanan Wadkar
//PRN- 2018BTEIT00047
#include <stdio.h> 
#include <sys/types.h> 
#include <sys/ipc.h> 
